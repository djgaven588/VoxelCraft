...
namespace VoxelCraft.Rendering
{
    public static class PrimitiveMeshes
    {
        ...
        public static void Init()
        {
            ...
            {
                new StandardMeshVertexData(new Vector3d(-0.5,  0.5, -0.5), new Vector2d(0, 0)),
                new StandardMeshVertexData(new Vector3d( 0.5,  0.5, -0.5), new Vector2d(1, 0)),
                new StandardMeshVertexData(new Vector3d( 0.5, -0.5, -0.5), new Vector2d(1, 1)),
                new StandardMeshVertexData(new Vector3d(-0.5, -0.5, -0.5), new Vector2d(0, 1)),
